  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      const tx = await createToken(
        ...
        prices,
        Math.floor(formData.royaltyBps * 100), // Convert to basis points
    ...
    switch (step) {
      ...
      case 2:
        return (
          ...
          formData.royaltyBps >= 0 &&
          formData.royaltyBps <= 10
        );
      case 3:
        return validateForm();
      default:
                  ...
                  <div>
                    ...
                    <div className="space-y-6">
                      <div>
                        ...
                        <div className="flex justify-between items-center mt-2">
                          <p className="text-sm text-gray-500 dark:text-gray-400">
                            You'll earn {formData.royaltyBps}% from each
                            resale
                          </p>
                          {formData.royaltyBps > 7.5 && (
                            <span className="text-xs text-amber-500 flex items-center space-x-1">
                              <FiAlertCircle className="w-3 h-3" />
                        ...
                        {formData.royaltyBps > 0 && (
                          <div className="p-3 bg-green-100 dark:bg-green-900/30 rounded-xl">
                            <p className="text-sm text-green-700 dark:text-green-300 font-medium">
                              You'll earn {formData.royaltyBps}% from
